...
HttpRequest* parseSimpleRequest(const std::string& rawRequest) {
    ...
    if (lineEnd == std::string::npos) return NULL;
    ...
    if (firstSpace == std::string::npos || secondSpace == std::string::npos) return NULL;
    ...
    if (headerEnd != std::string::npos) {
        ...
        while (pos < headerBlock.size()) {
            ...
            if (nextLine == std::string::npos) nextLine = headerBlock.size();
