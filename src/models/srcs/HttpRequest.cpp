...
void GetRequest::handle(HttpResponse &res)
{
    (void)res;
}
...
void HeadRequest::handle(HttpResponse &res)
{
    (void)res;
}
...
bool PutRequest::validate(std::string &err) const
{
    (void)err;
    return true;
}
void PutRequest::handle(HttpResponse &res)
{
    (void)res;
}
...
bool OptionsRequest::validate(std::string &err) const
{
    (void)err;
    return true;
}
void OptionsRequest::handle(HttpResponse &res)
{
    (void)res;
}
